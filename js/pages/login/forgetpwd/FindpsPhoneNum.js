...
export default class FindpsPhoneNum extends Component {
            ...
            <View style={{flex:1,flexDirection:'column',backgroundColor:'#F3F3F3'}}>
                <View style={styles.item_bottom}>
                    <View style={styles.item_left}>
                        <Text style={{fontSize:17,color:'black'}}>{'密保手机:'}</Text>
                    </View>

                    <View style={styles.container_text}>
                        <TextInput   onChangeText={(text) =>  this.setState({phone:text})} placeholder='密保手机' underlineColorAndroid='transparent' style={{ fontSize:16,flex:3}}></TextInput>
