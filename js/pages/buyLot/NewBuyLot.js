...
import NewLotBlockView from './NewLotBlockView';
import NewLotBlockViewThere from './NewLotBlockViewThere';
import NewLotBlockViewSport from './NewLotBlockViewSport';
var Dimensions = require('Dimensions');
var screenWidth = Dimensions.get('window').width;
var screenHeight = Dimensions.get('window').height;

class NewBuyLot extends Component {
    ...
    _views() {
        ...
        if (this.state.showStyle == 'block')
        {
            ...
            />);
            viewArr.push(<NewLotBlockViewSport
                key={1}
                type = {1}
            ...
            />);
            viewArr.push(<NewLotBlockViewThere
                key={2}
                type = {2}

                dataSource={this.allList}
                navigator={this.props.navigation}
                countDownFinished={() => this._fetchDataThere()}
                tabLabel='电子游戏'
                style={styles.page3}
                backAction={this.props.backAction}
