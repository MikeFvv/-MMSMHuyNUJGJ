...
export default class ShopContentAlertView extends Component {
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                >
                    <View style = {{ marginTop:SCREEN_HEIGHT-(iphone5S?260:340)-Adaption.Height((iphone5S?350:300)) - (iphoneX?34:0) , borderRadius:5, backgroundColor:'#ffffff', height:(iphone5S?260:340), width:SCREEN_WIDTH - 40}}>
                        <View style = {{flexDirection:'row', height:(iphone5S?50:60), borderBottomWidth:1, borderColor:'#e1e2e3'}}>
                        ...
                        ><AllenFadeInView hasContent={this.state.moneyText.length <= 0 ?false:true}  style={{position:'absolute',left:10,width:2,height:28,top:6,backgroundColor:'rgba(69,11,238,1.0)'}}>

                        </AllenFadeInView>
                            <Text allowFontScaling={false} style = {{color:this.state.moneyText.length <= 0 ? '#888' : '#000', marginLeft:15, fontSize:Adaption.Font(16,13), width:SCREEN_WIDTH - 40 - 60}}>
                                {this.state.moneyText.length <= 0 ? this.state.defaultMoneyText : this.state.moneyText}
                            </Text>
                            <Text allowFontScaling={false} style = {{color:'#171717', fontSize:Adaption.Font(17,14)}}>元</Text>
                        </TouchableOpacity>
                        <View style = {{height:(iphone5S?30:40), flexDirection:'row'}}>
                        ...
                        <View style = {{height:(iphone5S?25:35), flexDirection:'row', justifyContent:'center', marginLeft:16, marginTop:15}}>
                            ...
                            <View style ={{flex:0.58}}>
                                <Text allowFontScaling={false} style = {{color:'#171717', fontSize:Adaption.Font(15,12)}}>预计盈利:
                                    <Text allowFontScaling={false} adjustsFontSizeToFit={true} style = {{color:'#e56664', fontSize: Adaption.Font(15,12)}}>{(this.state.willWinPrice*this.state.slectMutipleOne*this.state.slectMutipleTwo).toFixed(2)}</Text>元
                                </Text>
                            </View>
                        </View>
                            ...
                            <TouchableOpacity
                                ...
                                onPress = {() => {
                                    if (this.state.subTotalPrice <= 0) {
                                        ...
                                        this.setState({isShow:false,slectMutipleOne:'1',slectMutipleTwo:'1'});
                                        this.props.comformBuyClick ? this.props.comformBuyClick(this.state.ballSourceArr,this.state.slectMutipleOne,this.state.slectMutipleTwo) : null
                                    }
                                }}
                                style = {{flex:0.49, justifyContent:'center', alignItems:'center'}}>
                    ...
                    {this.state.isShowKeyboardView ? this._createKeyboardView() : <View style = {{backgroundColor:'rgba(0,0,0,0)', height:Adaption.Height(iphone5S?350:300), width:SCREEN_WIDTH}}></View>}
                </View>
    ...
    _createKeyboardView() {
        return(
            <View style = {{marginTop:Adaption.Height((iphone5S?80:30)) , backgroundColor:'#bababf', height:Adaption.Height(270), width:SCREEN_WIDTH}}>
...
class AllenFadeInView extends Component {
    constructor(props) {
        super(props);
        // console.log("FadeInView构造",props);
        this.state = {
