            ...
            >
                ...
                >
                    <View style = {{ marginTop:SCREEN_HEIGHT-(iphone5S?290:290)-Adaption.Height((iphone5S?340:400)) - (iphoneX?34:0) , borderRadius:5, backgroundColor:'#ffffff', height:(iphone5S?340:400), width:SCREEN_WIDTH - 40}}>
                        <View style = {{flexDirection:'row', height:(iphone5S?60:60), borderWidth:0.5, borderColor:'#bababa',borderStyle:'dashed'}}>
                        ...
                        <View style = {{height:(iphone5S?55:55), flexDirection:'row',justifyContent:'space-around',paddingTop:10}}>
                            ...
                            <TouchableOpacity activeOpacity={0.8}
                                              style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', borderColor: '#d3d3d3', borderWidth: 1, borderRadius: 5, width: 55, height: 35 }}
                                              onPress={() => {

                                                  this.setState({moneyText:'50'});
                                                  this._resetSinglePrie('50');
                                              }}>
                        ...
                        <View style = {{height:(iphone5S?28:38), flexDirection:'row',alignItems: 'center',justifyContent:'space-around',paddingTop:10}}>
                        ...
                        <View style = {{height:(iphone5S?25:25), flexDirection:'row', justifyContent:'center', marginLeft:16, marginTop:15}}>
                            ...
                            {/*</View>*/}
                            <View>
                                <Text allowFontScaling={false} style = {{color:'#171717', fontSize:Adaption.Font(15,12)}}>若中奖预计盈利:
                        ...
                        <View style = {{flexDirection:'row',height:(iphone5S?40:50), borderTopWidth:1, borderColor:'#e1e2e3'}}>
                            ...
                            <TouchableOpacity
                                ...
                                style = {{flex:0.49, justifyContent:'center', alignItems:'center'}}>
                                <CusBaseText style = {{fontSize:Adaption.Font(18,15), color:'#0094e7'}}>确定</CusBaseText>
                            </TouchableOpacity>
                        </View>
                    </View>
