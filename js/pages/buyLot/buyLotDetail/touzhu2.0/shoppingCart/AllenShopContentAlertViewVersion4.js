...
export default class ShopContentAlertView extends Component {
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                >
                    <View style = {{ marginTop:SCREEN_HEIGHT-(iphone5S?290:290)-Adaption.Height((iphone5S?340:400)) - (iphoneX?-10:0) , borderRadius:5, backgroundColor:'#ffffff', height:(iphone5S?340:400), width:SCREEN_WIDTH - 40}}>
                    ...
                    ><AllenFadeInView hasContent={this.state.moneyText.length <= 0 ?false:true}  style={{position:'absolute',left:10,width:2,height:24,top:8,backgroundColor:'#456FEE'}}>
                        ...
                        <View style = {{height:(iphone5S?35:65), flexDirection:'row',justifyContent:'space-around',marginTop:this.state.isShowListView?15:25,paddingTop:this.state.isShowListView?0:0,alignItems:'center'}}>
                        ...
                        <View style = {{marginBottom:iphone5S?5:0,height:(iphone5S?(this.state.isShowListView?25:46):(this
                                .state.isShowListView?5:19)), flexDirection:'row',justifyContent:'space-around',paddingTop:15,borderBottomWidth:1,borderBottomColor:'#d3d3d3'}}>
                            {/*<View style = {{flex:1, alignItems:'center', flexDirection:'row', justifyContent:'center'}}>*/}
                            {/*<CusBaseText style={{color:"#7d7d7d"}}>追  </CusBaseText>*/}
                            {/*<TextInput allowFontScaling={false} keyboardType = {global.iOS?'number-pad':'numeric'} onChangeText = {(text) => {*/}
                            {/*//输入倍数时的计算*/}
    ...
    _createKeyboardView() {
        return(
            <View style = {{marginTop:Adaption.Height((iphone5S?10:24)) , backgroundColor:'#bababf', height:Adaption.Height(270), width:SCREEN_WIDTH}}>
    ...
    _renderItemBallNumberView(item) {
        ...
        return (<View key={item.index+"21"}style = {{paddingHorizontal:10,marginTop:10 , width:SCREEN_WIDTH - 40,  justifyContent:'center', alignItems:'center'}}>
